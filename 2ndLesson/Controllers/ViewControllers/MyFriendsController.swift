...
//            let myPhoto = MyFoto(url: "44")
            ...
            let friend1 = Friend(name: "Ivana", age: "34", avatar: "1", fotoAlbum: ["1","3"])
            let friend2 = Friend(name: "Victoria", age: "27", avatar: "2", fotoAlbum: [])
            let friend3 = Friend(name: "Petr", age: "23", avatar: "11", fotoAlbum: [])
            let friend4 = Friend(name: "Roman", age: "14", avatar: "22", fotoAlbum: [])
            let friend5 = Friend(name: "Alexa", age: "27", avatar: "3", fotoAlbum: [])
            let friend6 = Friend(name: "Sam", age: "23", avatar: "33", fotoAlbum: [])
...
extension MyFriendsController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let friend = myFriends[indexPath.row] //массив фоток друзей
